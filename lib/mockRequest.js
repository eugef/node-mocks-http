...
function createRequest(options) {
     ...
     * @public
     */
    mockRequest.acceptsEncodings = function (...args) {
        let encodings = args;
     ...
     * @public
     */
    mockRequest.acceptsCharsets = function (...args) {
        let charsets = args;
     ...
     * @public
     */
    mockRequest.acceptsLanguages = function (...args) {
        let languages = args;
